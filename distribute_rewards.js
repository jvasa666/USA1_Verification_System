...
const totalTransactions = 10000000;
...
console.log(`Total accumulated earnings for CAGE 17ZE9: $${totalEarnings.toFixed(2)} USD`);
...
const req = http.request({
    ...
    res.on('end', () => {
        console.log("REWARD DISTRIBUTION STATUS:", body);
    });
});
